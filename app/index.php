...
?>
  ...
  <body class="sb-nav-fixed">
    <nav class="text-warning sb-topnav navbar navbar-expand navbar-dark bg-dark">
      <a class="navbar-brand ps-3 text-warning" href="index.php"><i class="bi bi-shop"></i> Mamyami King of Korean Food</a>
              ...
              <div class="sb-sidenav-menu">
                <div class="nav mt-3">
                  <a class="nav-link" href="dash.php" target="konten">
                    <div class="sb-nav-link-icon"><i class="bi bi-clipboard2-data-fill"></i></div> Dashboard
                  </a>
                  <hr>
                  <a class="nav-link" href="tools.php" target="konten">
                    <div class="sb-nav-link-icon"><i class="bi bi-list-nested"></i></div> Tools Produk
                  </a>
