							...
							<tr>
								...
								<td>						
									<button onclick="document.location='?idb=<?=$s['kode_barang']?>'" class="btn btn-success" type="submit">
										<i class="bi bi-cart-plus-fill"> Tambah</i>
									</button>	
								</td>
							</tr>
						</tbody>
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<table class="table table-bordered w-100 mb-2" id="example1">
								...
								<tbody>
									<tr>
										<td> <input type="text" class="btn" name="nama_produk" value="<?=@$kodb['nama_produk']?>"></td>
										<td>
											<input type="number" name="qty" required>
										</td>
										<td>Rp. <input type="text" class="btn" name="harga_produk" value="<?=@$kodb['harga']?>"></td>
									</tr>
								</tbody>
							</table>
							<div class="row g-3 align-items-center mb-2">
								<div class="col-auto">
									<button class="btn btn-success" type="submit"><i class="bi bi-cart-plus-fill"></i> Tambah</button>
								</div>
								<div class="col-auto">
										...
										<table class="table table-bordered">
											...
											?>
												<tr>
													...
													<td><?= $s['tgl'] ?></td>
													<td>
														<button class="btn btn-danger" onclick="document.location.href='hapus_pesanan.php?id=<?= $s['id'] ?>'">Batal</button>
													</td>
												</tr>
												<?php
    													}
